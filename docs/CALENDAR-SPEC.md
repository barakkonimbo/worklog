...
> סטטוס: **נבנה ואומת חי** (v0.7.0, 2026-06-04; **v0.7.3** — mirror מתמשך; **v0.7.4** — fallback מבוסס-רשומות + תיאור HTML; **v0.7.6** — בלוקים מבוססי-שכבת-פעילות) — `--setup` / `--test` / `--sync` / אידמפוטנטיות ✅.
