...
`גרסה 0.7.4` · `Windows (mac/Linux חלקי)` · `ללא תלות חיצונית (Node + Claude CLI)`
...
- **Google Calendar (opt-in)** — **mirror מתמשך** של היום: בלוקי-זמן לפי פרויקט (מעוגני-סשנים) + אירוע "סיכום יום", ביומן ייעודי **"Work Journal"**. מתעדכן בכל סגירת סשן (גם אם עבדת אחרי 20:30) — בלי לגעת באירועים אמיתיים.
...
│   ├── DECISIONS.md       ← החלטות תכנון D1–D13 + מלכודות
